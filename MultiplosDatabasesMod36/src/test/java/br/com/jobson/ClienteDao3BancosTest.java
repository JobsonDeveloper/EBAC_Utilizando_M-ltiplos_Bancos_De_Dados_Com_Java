...
import br.com.jobson.dao.ClienteDB2DAO;
import br.com.jobson.dao.ClienteDB3DAO;
...
public class ClienteDao3BancosTest {
	...
	private IClienteDAO<Cliente> clienteDB3Dao;
	...
	public void end() throws DAOException {
		...
		Collection<Cliente> list3 = clienteDB3Dao.buscarTodos();
		excluir2(list3);
	}
	...
	public void pesquisarCliente()
		...
		Cliente clienteConsultado3 = clienteDB3Dao.consultar(cliente.getId());
